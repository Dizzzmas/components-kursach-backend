...
def upgrade():
    ...
    sa.Column('extid', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'), nullable=False),
    sa.Column('type', sa.Enum('marriage', 'birth', 'death', name='acttype'), nullable=False),
