...
# use local "db_kursach_s2" DB for local dev
DEFAULT_DB_URL = "postgresql:///db_kursach_s2"
...
class Config:
    ...
    APP_SECRETS_NAME = os.getenv("APP_SECRETS_NAME", "db_kursach_s2/dev")
...
class ProductionConfig(Config):
    ...
    APP_SECRETS_NAME = "db_kursach_s2/prd"
...
def check_valid_handler(event, context):
    ...
    config_class = event.get("env", "db_kursach_s2.config.LocalDevConfig")
