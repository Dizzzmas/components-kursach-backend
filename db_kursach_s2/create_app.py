...
def configure_class(app: App) -> None:
    ...
    config_class = os.getenv("db_kursach_s2_CONFIG".upper())
    ...
    if not config_class:
        ...
        if stage:
            ...
            if stage == "prd":
                config_class = "db_kursach_s2.config.ProductionConfig"
            else:
                config_class = "db_kursach_s2.config.DevConfig"
        else:
            # local dev
            config_class = "db_kursach_s2.config.LocalDevConfig"
...
def init_xray(app: App) -> None:
    ...
    xray_recorder.configure(service="db_kursach_s2")
